 ...
 * Uses Claude AI to intelligently merge changes while preserving customizations in B
 * 
 ...
 */
export const mergeAndCreatePR = async (diffText, latestCommit, commitMessages = []) => {
    ...
    try {
        ...
        console.error("❌ Error in mergeAndCreatePR:", err);
